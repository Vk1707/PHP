...
if(isset($_POST['getpass']))
{
	...
	$tsql = "SELECT * FROM `sc_getpass` ORDER BY sc_sno DESC LIMIT 1";
							...
							<?php
								if(isset($_GET['ids']))
								{
									...
									echo "
										...
										<table class='table text-secondary table-bordered'>
										<tr>
                                            <td>Approved By</td><td>".$row['sc_generator']."</td>
                                            
                                        </tr>
                                        <tr>
                                            <td>Date</td><td>".$row['sc_getdate']."</td>
                                            
                                        </tr>
                                        <tr>
                                            <td>Time</td><td>".$row['sc_gettime']."</td>
