...
if(isset($_POST['pass']))
{
	...
	$tsql = "SELECT * FROM `sc_users` WHERE sc_pass='$oldpass' AND sc_email='$ademail'";
					...
					<div class="dis-card">
						...
						<form class="" method="POST">
              				<div class="form-group">
								<input type="password" name="oldpass" class="form-control" required placeholder="Old Password...">
							</div>
							<div class="form-group">
