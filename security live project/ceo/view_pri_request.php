				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php
							...
							$tsql = "SELECT * FROM `pri_sim_request` where cio_feedback='Approved' AND (ceo_feedback='' OR ceo_feedback='On Hold') order by sr_no desc";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									$avp_email=$trow['avp_emailid'];
									if ($trow['requirement']=="PRI")
									{ ?>
									<td><a href="pri_feedback.php?id=<?php echo $trow['ticket_no'];?>&p=<?php echo $trow['pri_140_count'];?>&t=<?php echo $trow['pri_140_details'];?>&r=<?php echo $trow['request_date'];?>&pr=<?php echo $trow['process_name'];?>&e=<?php echo $avp_email;?>"> Click to Give Feedback</a></td>
									 <?php } 

									else if ($trow['requirement']=="SIM")
									{?>
										<td><a href="sim_feedback.php?id=<?php echo $trow['ticket_no'];?>&p=<?php echo $trow['sim_count'];?>&t=<?php echo $trow['sim_details'];?>&r=<?php echo $trow['request_date'];?>&pr=<?php echo $trow['process_name'];?>&e=<?php echo $avp_email;?>"> Click to Give Feedback</a></td>
									<?php } ?>
									</tr>
									}
								</tr>
