<div class="sidebar-menu">
	...
	<ul class="side-list">
	   ...
	   <li><a href="ticket_view.php"><i class="fa fa-ticket"></i> View Tickets</a></li>
       <li><a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-ticket"></i> ISMS Request</a>
       <div class="dropdown-menu">
        			<a class="dropdown-item" href="isms-test-request-view.php"> <i class="fa fa-history"></i> ISMS Session Request</a>
        			<a class="dropdown-item" href="isms-session-officer.php"> <i class="fa fa-history"></i> ISMS Session Officer</a>
