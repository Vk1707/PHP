...
if(isset($_POST['cansub']))
{
	...
	$sql = "UPDATE `sc_wifiaccess` SET sc_wifit='1',	sc_itcom='$ismscmnt' WHERE sc_sno='$wid'";
...
if(isset($_POST['canclesub']))
{
	...
	$sql = "UPDATE `sc_wifiaccess` SET sc_wifit='2',	sc_itcom='$ismscmnt',sc_wifiactive='2' WHERE sc_sno='$wid'";
	$res = mysqli_query($conn,$sql);
