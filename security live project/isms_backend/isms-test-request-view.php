...
<td><a href="assign-session.php?batch=<?php echo $trow['batch_id'] ?>"><?php echo $trow['batch_name']; ?></a></td>
...
<input type="hidden" name="del_id" value="<?php echo $trow['id'] ?>">
<button type="submit" name="del_batch" class="btn btn-danger">Delete</button>
</form>
</td>
</tr>
<?php
...
$qry_del = "DELETE FROM `sc_batch` WHERE id= '$del_id'";
$qry_del_fire = $conn->query($qry_del);
if ($qry_del_fire) {
echo '<script>
alert("Deleted");
window.location.href="./isms-test-request-view.php";
