...
if(isset($_POST['comsub']))
{
	...
	$shl = str_replace("."," ",$td);
		...
		$esql = "UPDATE `sc_emailcreation` SET `sc_hrdepart`='2', `sc_hrcomment`='$comment',sc_status='0' WHERE `sc_sno`='$sn'";
	...
	if($eres == true)
	{
		...
		$mail->addCC('aarti.dogra@silaris.in','Aarti Dogra');
		$mail->Subject = 'Email ID Creation Request';
    	$mail->Body.= 'Hi, <br>Kindly login in http://isms.silaris.in & approve the email id creation request of below mention employee.<br><br>';
			...
			<?php
            		if(isset($_GET['sid']))
                    {
                          ...
                          <div class="form-group">
                          	...
                          	<div class="form-group">
                          <input type="submit" name="comsub" class="btn btn-danger" value="Reject">
                          	</div>
