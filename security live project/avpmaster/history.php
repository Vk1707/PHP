				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						if(isset($_GET['emid']))
						{
							...
							$gid = $_GET['emid'];
							$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_empid LIKE '%$gid%' AND sc_status='1' AND `sc_action`='1'";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									<td><?php echo $trow['sc_alreadyemail'];?></td>
						...
						{
							$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_status='1' AND `sc_action` IN ('0','1') AND sc_processhead='$ademail'";
							$tres = mysqli_query($conn,$tsql);
							while($trow = mysqli_fetch_array($tres))
							{
								?>
