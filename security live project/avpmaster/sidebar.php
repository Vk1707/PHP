	...
	<ul class="side-list">
		...
		<li class="nav-item dropdown"><a href="" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-history"></i> History</a>
				<div class="dropdown-menu">
					...
					<a class="dropdown-item" href="approval-history.php"> <i class="fa fa-history"></i> Approval History</a>
       ...
       <li><a href="website-access.php"><i class="fa fa-globe"></i>Website Access</a></li>
		<li><a href="pri_sim_request.php"><i class="fa fa-address-card"></i>PRI/SIM Requests</a></li>
	</ul>
</div>
