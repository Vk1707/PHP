			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_emailteam='1' AND `sc_action`='2' ORDER BY sc_sno DESC";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									<td><?php echo $trow['sc_externalids'];?><br><?php echo $trow['sc_trainerids'];?><br><?php echo $trow['sc_adminids'];?><br><?php echo $trow['sc_itismsids'];?><br><?php echo $trow['sc_oprationids'];?></td>
									...
									if($hrid == "1")
									{
										echo '<a href="ent-email-providing.php?sid='.$eval.'" class="aprv">Approve</a>';
									}
									else
									{
										echo "";
