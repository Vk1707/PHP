			  ...
			  <hr size="8" width="100%" color="#23262C"><br>
					...
					<tbody>
						<?php
							...
							$sql1="select * from sc_users where sc_email='$ademail'";
							$res1=mysqli_query($conn,$sql1);
							$row1 = mysqli_fetch_array($res1);
							$process=$row1['sc_process'];
							$tsql = "SELECT count(*) as total,process_name FROM `pri_tracker` where process_name='$process' group by process_name  order by sr_no desc";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									<td><a href="pri_details.php?id=<?php echo $p;?>"> Click here to see Details</a></td>
								</tr>
								<?php
