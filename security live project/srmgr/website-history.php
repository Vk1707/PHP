				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php
							...
							$tsql = "SELECT * FROM `website_access` WHERE (manager_email_id='$ademail') AND ((isms_status='2') OR (isms_status='1' AND ceo_status='1' AND network_status='1'))order by access_id desc";
