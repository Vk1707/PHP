...
if(isset($_POST['resetpass']))
{
    ...
    if($logpass==$rpass)
    {
       ...
       alert('Please Provide a New Password!');</script>";

   
    }
  
     else if($logpass == $clogpass)
    	{
        $sql = "UPDATE `sc_users` SET sc_pass='$logpass' , sc_uploadon='$d3' WHERE sc_status='1' AND sc_email='$em'";
        $res = mysqli_query($conn,$sql);
        	if($res == true)
        	{
