...
<div class="guard-lp">
    <div class="guard-sidebar">
        ...
        <div class="guard-menu">
            <p>History</p>
            <?php
            $sql = "SELECT * FROM `sc_getpass` WHERE `sc_action`='0' AND sc_building='A-6'";
        ...
        <div class="guard-mainbar-top">
                ...
                <ul>
                    <li>
                        ...
                        <a href="a-6.php"><i class="fa fa-home"></i> Home</a>
                    </li>
                    <li>

                        <a href="history6a.php"><i class="fa fa-history"></i> History</a>
                    </li>
                    <li>
                        <i class="fa fa-user"></i> Security Guard A-6
                    </li>
                </ul>
