...
<div class="guard-lp">
    <div class="guard-sidebar">
        ...
        <div class="guard-menu">
            <p>History</p>
            <?php
            $sql = "SELECT * FROM `sc_getpass` WHERE `sc_action`='1' AND sc_building='14/2'";
            ...
            if(mysqli_num_rows($res) > 0)
            {
                while($row = mysqli_fetch_array($res))
                {
                    ?>
                    <ul>
                        <li><a href="s14-2.php?p=<?php echo $row['sc_sno'];?>"><?php echo $row['sc_empname'];?></a></li>
                    </ul>
                    <?php
                }
            }
        ...
        <div class="guard-mainbar-top">
                ...
                <ul>
                    <li>
                        ...
                        <a href="s14-2.php"><i class="fa fa-home"></i> Home</a>
                    </li>
                    <li>

                        <a href="history2.php"><i class="fa fa-history"></i> History</a>
                    </li>
                    <li>
                        <i class="fa fa-user"></i> Security Guard 14/2
                    </li>
                </ul>
        ...
        <div class="guard-pass">
            ...
            <?php
                if(isset($_GET['p']))
                {
                    ...
                    echo "
                                        <tr>
                                            <td colspan='2' class='text-center'> Gate Pass For Employee<br>
                                        ...
                                        <tr>
                                            <td><form method='post'><input type='submit' value='OK' class='btn btn-danger float-right' name='fine'></form></td>
