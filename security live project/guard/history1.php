...
<div class="guard-lp">
    <div class="guard-sidebar">
        ...
        <div class="guard-menu">
            <p>History</p>
            <?php
            $sql = "SELECT * FROM `sc_getpass` WHERE `sc_action`='1' AND sc_building='14/1' ORDER BY sc_sno DESC";
            ...
            if(mysqli_num_rows($res) > 0)
            {
                while($row = mysqli_fetch_array($res))
                {
                    ?>
                    <ul>
                        <li><a href="history1.php?p=<?php echo $row['sc_sno'];?>"><?php echo $row['sc_empname'];?></a></li>
                    </ul>
                    <?php
                }
            }
