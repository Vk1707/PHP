...
<div class="guard-lp">
    <div class="guard-sidebar">
        ...
        <div class="guard-menu">
            <p>Gate Pass</p>
            <?php
            $sql = "SELECT * FROM `sc_getpass` WHERE `sc_action`='0' AND sc_building='14/1'";
            ...
            if(mysqli_num_rows($res) > 0)
            {
                while($row = mysqli_fetch_array($res))
                {
                    ?>
                    <ul>
                        <li><a href="s14-1.php?p=<?php echo $row['sc_sno'];?>"><?php echo $row['sc_empname'];?></a></li>
                    </ul>
                    <?php
                }
            }
        ...
        <div class="guard-mainbar-top">
                ...
                <ul>
                    <li>
                        ...
                        <a href="s14-1.php"><i class="fa fa-home"></i> Home</a>
                    </li>
                    <li>

                        <a href="history1.php"><i class="fa fa-history"></i> History</a>
                    </li>
                    <li>
                        <i class="fa fa-user"></i> Security Guard 14/1
                    </li>
            		<li>
