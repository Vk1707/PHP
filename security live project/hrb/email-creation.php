...
if(isset($_POST['emailcase']))
{
	...
	$csql = "INSERT INTO `sc_emailcreation`(`sc_empname`, `sc_empid`, `sc_process`, `sc_designation`, `sc_suggestemail`, `sc_reportingto`, `sc_processhead`,`sc_hrdepart`,`sc_hrcomment`, `sc_status`, `sc_action`, `sc_createdon`, `sc_createdby`, `sc_createdemail`) VALUES ('$empname','$empid','$process','$desigtn','$emailad','$reporting','$manager','1','Ok from my side!','1','0','$daytime','$adname','$ademail')";
	$cres = mysqli_query($conn,$csql);

		$mail->addAddress('sunita.yadav@silaris.in', 'Sunita Yadav');
		$mail->addCC($ademail,$adname);
		$mail->Subject = 'Email ID Creation Request';
    	$mail->Body.= 'Dear Sir/Ma\'am, <br>Kindly approve for below mention employee. To approve, kindly visit http://isms.silaris.in/ <br><br>';
    	...
    	$mail->Body.='</table>';
    	$mail->Body.='<br><br>';
    	$mail->Body.='This Employee Confirm form my Side.';
    	$mail->Body.='<br><br>';
    	$mail->Body.='Thank you!';
    	$mail->send();
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_hrdepart='0' AND sc_action IN ('0') ORDER BY sc_sno DESC";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									if($hrid == "0")
									{
										echo '<a href="del-email-creation.php?sid='.$eval.'" class="reject">Reject</a>';
									}
									else
									{
										echo "";
			...
			<div class="form-group row">
				<div class="col-lg-6 col-md-6">
					...
					<select name="manager" class="form-control" required>
                        ...
                        <option value="samarth.jain@silaris.in">Samarth Jain</option>			<option value="puneet.bhutani@silaris.in">Puneet Bhutani</option>
