...
if(isset($_POST['comsub']))
{
	...
	$shl = str_replace("."," ",$td);
		...
		$esql = "UPDATE `sc_emailcreation` SET `sc_hrdepart`='1', `sc_hrcomment`='$comment' WHERE `sc_sno`='$sn'";
	...
	if($eres == true)
	{
    	...
    	$mail->Body.= 'Hi ISMS Officer, <br> <br> HR Dept. has share the details of email id, kinldy check and approve. Kindly login in http://isms.silaris.in <br><br>';
