...
if(isset($_POST['cansub']))
{
	...
	$sql = "UPDATE `sc_wifiaccess` SET sc_wifivp='1',	sc_vpcom='$ismscmnt' WHERE sc_sno='$wid'";
...
if(isset($_POST['canclesub']))
{
	...
	$sql = "UPDATE `sc_wifiaccess` SET sc_wifivp='2',	sc_vpcom='$ismscmnt',sc_wifiactive='2' WHERE sc_sno='$wid'";
	$res = mysqli_query($conn,$sql);
