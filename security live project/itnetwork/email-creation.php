...
if(isset($_POST['emailcase']))
{
	...
	$csql = "INSERT INTO `sc_emailcreation`(`sc_empname`, `sc_empid`, `sc_process`, `sc_designation`, `sc_suggestemail`, `sc_reportingto`, `sc_processhead`,`sc_itavp`,`sc_itavpcomment`, `sc_status`, `sc_action`, `sc_createdon`, `sc_createdby`, `sc_createdemail`) VALUES ('$empname','$empid','$process','$desigtn','$emailad','$reporting','$manager','1','Ok from my side!','1','0','$daytime','$adname','$ademail')";
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_itavp='0' AND sc_action='0'";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									<td><?php echo $trow['sc_reportingto'];?>
