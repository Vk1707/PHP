...
if(isset($_POST['sub']))
{
	...
	$avp_name=$process[2];
   		...
   		$sql1="select * from pri_sim_request";
			...
			$sql2="INSERT INTO `pri_sim_request`(`sr_no`,`process_name`, `avp_emailid`, `ticket_no`) VALUES ('$sr_no','$process_name','$avp_emailid','$sr_no')";


			$res2 = mysqli_query($conn,$sql2);


			$sql3="select count(*) from pri_tracker where process_name='$process_name' and type='PRI-140'";
			...
			$sql4="select count(*) from pri_tracker where process_name='$process_name' and type='PRI-Normal'";
			...
			$sql5="select count(*) from pri_tracker where process_name='$process_name' AND (type='2G' OR type='Volte')";
			...
			header('location:pri_request_form.php?p='.$process_name);
		}
				...
				<div class="container">
					<div class="jumbotron ">
						...
						<hr size="8" width="100%" color="#23262C"><br>
				 				...
				 				<input type="radio" name="process_name" value="HDFC ERGO,vinod.anand@silaris.in,Vinod Anand">
