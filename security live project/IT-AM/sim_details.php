...
?>
	...
	<div class="main-dash">
				...
				<div class="row" >
							...
							<select id="choice" style="margin-left:10px;margin-right:100px;border-radius:10px;padding:10px" onchange="showprovider(this.value)" required>
								 ...
								 <option value="Provided by Client,Provided by Silaris,<?php echo $process?>">All</option>
  								 <option value="Provided by Client, ,<?php echo $process?>">Client Provided SIM</option>
  								 <option value="Provided by Silaris, ,<?php echo $process?>">Silaris Provided SIM</option>
  							</select>
		...
		<div id="txtHint">SIM info will be listed here...</div>			
<script>
function showprovider(str) {
  ...
  xhttp.open("GET", "table_sim.php?id="+str, true);
  xhttp.send();
}
