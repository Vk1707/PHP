...
if(isset($_POST['emailcase']))
{
	...
	$csql = "INSERT INTO `sc_emailcreation`(`sc_empname`, `sc_empid`, `sc_designation`, `sc_suggestemail`, `sc_reportingto`, `sc_status`, `sc_action`, `sc_createdon`, `sc_createdby`, `sc_createdemail`) VALUES ('$empname','$empid','$depart','$emailad','$manager','1','0','$daytime','$adname','$ademail')";
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_status='1' AND sc_action='0'";
		...
		<form class="" method="POST" action="" enctype="multipart/form-data">
			...
			<div class="form-group row">
				<div class="col-lg-12 col-md-12">
					...
					<textarea name="emailad" class="form-control" required></textarea>
