			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_wifiaccess` WHERE sc_status='1' ORDER BY sc_sno DESC";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									<td><a href="?del=<?php echo $trow['sc_sno'];?>" class='blred'>Delete</a></td>
									<td><a href="wifi-access-download.php?tid=<?php echo $trow['sc_sno'];?>"><i class="fa fa-download"></i></a></td>
								</tr>
								<?php
								$num++;
							}
