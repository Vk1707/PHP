...
{
	$cid = $_GET['cid'];
	$cst = "UPDATE `sc_ccrmdata` SET sc_d_action='1' WHERE sc_ccrmno='$cid'";
				...
				<div class="col-lg-3 col-md-3">
					<div class="dis-menu">
						...
						<ul class="dis-file-menu">
							<?php
								$sql = "SELECT * FROM `sc_ccrmdata` WHERE `sc_status`='1' AND `sc_informed_d`='$ademail'";
								$res = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_array($res))
								{
									if($row['sc_d_action'] == "0")
									{
