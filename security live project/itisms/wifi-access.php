...
if(isset($_POST['wifiaccess']))
{
	...
	$systemsmac = $_POST['systemsmac'];
	$accessdate = $_POST['accessdate'];
	$timehr = $_POST['timehr'];

	$sql = "SELECT * FROM `sc_wifiaccess`";
	...
	{
		$wifi = "INSERT INTO `sc_wifiaccess`(`sc_wifiaccessid`, `sc_wifiname`, `sc_wifidesinations`, `sc_wifiprocess`, `sc_wifiguest`, `sc_wifiempid`, `sc_wifiassets`, `sc_wifisystem`, `sc_wifidate`, `sc_wifiperiod`, `sc_createdby`, `sc_createdon`, `sc_status`) VALUES ('WIFI0','$empname','$desig','$depart','$foruser','$intenal','$laptopuser','$systemsmac','$accessdate','$timehr','$adname','$daytime','1')";
...
<table style="width:100%">
	...
	{
		$wifi = "INSERT INTO `sc_wifiaccess`(`sc_wifiaccessid`, `sc_wifiname`, `sc_wifidesinations`, `sc_wifiprocess`, `sc_wifiguest`, `sc_wifiempid`, `sc_wifiassets`, `sc_wifisystem`, `sc_wifidate`, `sc_wifiperiod`, `sc_createdby`, `sc_createdon`, `sc_status`) VALUES ('$vat','$empname','$desig','$depart','$foruser','$intenal','$laptopuser','$systemsmac','$accessdate','$timehr','$adname','$daytime','1')";
		$wires = mysqli_query($conn,$wifi);
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_wifiaccess` WHERE sc_status='1' AND sc_wifisms='0' AND sc_wifiactive='0' ORDER BY sc_sno DESC";
