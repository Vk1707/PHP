...
if(isset($_POST['comsub']))
{
	...
	$shl = str_replace("."," ",$td);
		...
		$esql = "UPDATE `sc_emailcreation` SET `sc_isms`='2', `sc_ismscomment`='$comment' WHERE `sc_sno`='$sn'";
	...
	if($eres == true)
	{
		...
		$mail->Subject = 'Email ID Creation Request Rejected';
    	$mail->Body.= 'Hi '.$unam.', <br> <br> ISMS Officer has reject your request to create email id with below mention reason.<br><br>';
			...
			<?php
            		if(isset($_GET['sid']))
                    {
                          ...
                          <div class="form-group">
                          	...
                          	<div class="form-group">
                          <input type="submit" name="comsub" class="btn btn-danger" value="Submit">
                          	</div>
