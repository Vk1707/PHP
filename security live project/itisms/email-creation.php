...
if(isset($_POST['emailcase']))
{
	...
	$csql = "INSERT INTO `sc_emailcreation`(`sc_empname`, `sc_empid`, `sc_process`, `sc_designation`, `sc_suggestemail`, `sc_reportingto`, `sc_processhead`,`sc_processavp`,`sc_avpcomment`, `sc_status`, `sc_action`, `sc_createdon`, `sc_createdby`, `sc_createdemail`) VALUES ('$empname','$empid','$process','$desigtn','$emailad','$reporting','$manager','1','Ok from my side!','1','0','$daytime','$adname','$ademail')";
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive">
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						<?php
						$num =1;
							$tsql = "SELECT * FROM `sc_emailcreation` WHERE sc_hrdepart='1' AND sc_isms='0' AND sc_itavp ='0' AND sc_itdepart='0' ORDER BY sc_sno DESC";
							...
							while($trow = mysqli_fetch_array($tres))
							{
								...
								<tr>
									...
									if($hrid == "0")
									{
										echo '<a href="ent-email-creation-rej.php?sid='.$eval.'" class="reject">Reject</a>';
									}
									else
									{
										echo "";
