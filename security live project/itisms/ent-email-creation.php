...
if(isset($_POST['comsub']))
{
	...
	$shl = str_replace("."," ",$td);
		...
		$esql = "UPDATE `sc_emailcreation` SET `sc_isms`='1', `sc_ismscomment`='$comment' WHERE `sc_sno`='$sn'";
	...
	if($eres == true)
	{
    	...
    	$mail->Body.= 'Hi Email Support, <br> <br> ISMS has given the security clearance to create email id , now kindly login in http://isms.silaris.in & process the request of below mention employee<br><br>';
